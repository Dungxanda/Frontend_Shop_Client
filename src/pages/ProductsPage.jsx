  ...
  useEffect(() => {
    if (categoryData === null) {
      ...
      const category = categoriesData.find(
        (cat) => cat.title.toLowerCase() === categoryData.toLowerCase()
      );
      setCategoryName(category ? category.title : "Không xác định");
    }
      ...
      {isLoading ? (
        ...
        <div>
          ...
          <div className={`${styles.section} mb-10`}>
            <h2 className="text-3xl font-bold text-center">{categoryName}</h2>
          </div>
